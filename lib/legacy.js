    ...
    lumi_on_off_action: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (utils.isLegacyEnabled(options)) {
                ...
                return fromZigbee_1.default.lumi_on_off_action.convert(model, msg, publish, options, meta);
            }
        },
    },
    WXKG02LM_click: {
    ...
    lumi_multistate_action: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            if (utils.isLegacyEnabled(options)) {
                ...
                return fromZigbee_1.default.lumi_multistate_action.convert(model, msg, publish, options, meta);
            }
        },
    },
    E1744_play_pause: {
