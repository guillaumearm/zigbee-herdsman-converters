...
exports.ledvanceLight = exports.ledvanceOnOff = exports.ledvanceTz = exports.ledvanceFz = void 0;
const modernExtend = __importStar(require("./modernExtend"));
const utils_1 = require("./utils");
const utils = __importStar(require("../lib/utils"));
const zigbee_herdsman_1 = require("zigbee-herdsman");
const ota = __importStar(require("../lib/ota"));
const manufacturerOptions = { manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.OSRAM };
exports.ledvanceFz = {
    pbc_level_to_action: {
