...
exports.philipsFz = exports.tz = exports.philipsTz = exports.philipsOnOff = exports.philipsLight = void 0;
...
function philipsLight(args) {
    ...
    if (args.hueEffect || args.gradient) {
        ...
        if (args.gradient) {
            ...
            e.enum('gradient_scene', ea.SET, Object.keys(gradientScenes)), e.list('gradient', ea.ALL, e.text('hex', ea.ALL).withDescription('Color in RGB HEX format (eg #663399)'))
                .withLengthMin(1)
                .withLengthMax(9)
