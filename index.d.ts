...
import { Definition, Zh, OnEventData, OnEventType, Expose, Tz, OtaUpdateAvailableResult, KeyValue, Logger } from './lib/types';
...
export declare function postProcessConvertedFromZigbeeMessage(definition: Definition, payload: KeyValue, options: KeyValue, logger: Logger): void;
