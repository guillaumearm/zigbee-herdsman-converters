...
const definitions = [
    ...
    },
    {
        ...
        extend: [(0, ledvance_1.ledvanceLight)({ configureReporting: true, endpoints: { 'l1': 10, 'l2': 11 }, ota: ota.zigbeeOTA })],
    },
    {
        ...
        extend: [(0, ledvance_1.ledvanceLight)({ configureReporting: true, endpoints: { 'l1': 10, 'l2': 11, 's1': 25 }, ota: ota.zigbeeOTA })],
        fromZigbee: [fromZigbee_1.default.command_toggle, fromZigbee_1.default.command_move, fromZigbee_1.default.command_stop],
