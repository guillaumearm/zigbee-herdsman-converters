...
const definitions = [
    {
        ...
        ota: ota.zigbeeOTA,
        extend: [(0, modernExtend_1.light)({ colorTemp: { range: undefined }, color: true, endpoints: { rgb: 10, white: 11 } })],
    },
    {
        zigbeeModel: ['FLS-CT'],
        model: 'XVV-Mega23M12',
    ...
    },
    {
        ...
        ota: ota.zigbeeOTA,
        extend: [(0, modernExtend_1.light)({ colorTemp: { range: [153, 370] }, color: true }), (0, modernExtend_1.batteryPercentage)()],
    },
    {
        ...
        extend: [(0, modernExtend_1.light)({ endpoints: { l1: 11, l2: 12, l3: 13, l4: 14 } })],
