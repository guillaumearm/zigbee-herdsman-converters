...
const definitions = [
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.onOff)({ endpoints: { top: 1, bottom: 2 }, powerOnBehavior: false, configureReporting: false })],
    },
    {
        ...
        extend: [(0, modernExtend_1.onOff)({ endpoints: { top: 1, center: 2, bottom: 3 }, powerOnBehavior: false, configureReporting: false })],
    },
    {
        ...
        extend: [(0, modernExtend_1.onOff)({ endpoints: { top_left: 1, bottom_left: 2, top_right: 3, bottom_right: 4 }, powerOnBehavior: false, configureReporting: false })],
    },
    {
        ...
        extend: [(0, modernExtend_1.onOff)({ endpoints: { top_left: 1, center_left: 2, bottom_left: 3, top_right: 4, bottom_right: 5 }, powerOnBehavior: false,
