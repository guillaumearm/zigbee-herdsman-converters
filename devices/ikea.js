...
exports.tradfriLight = tradfriLight;
...
const definitions = [
    ...
    },
    {
        ...
        vendor: 'IKEA',
        extend: [(0, modernExtend_1.onOff)({ ota: ota.tradfri })],
    },
    {
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.battery_percentage_remaining, toZigbee_1.default.identify],
        ota: ota.tradfri,
        configure: async (device, coordinatorEndpoint, logger) => {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fzLocal.ikea_dots_click_v2_somrig],
        toZigbee: [toZigbee_1.default.battery_percentage_remaining],
        exposes: [
