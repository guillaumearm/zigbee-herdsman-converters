...
const { lumiAction, lumiOperationMode, lumiPowerOnBehavior, lumiZigbeeOTA, lumiSwitchType, lumiAirQuality, lumiVoc, lumiDisplayUnit, lumiLight, lumiOutageCountRestoreBindReporting, lumiElectricityMeter, lumiPower, lumiOverloadProtection, lumiLedIndicator, lumiButtonLock, } = lumi.modernExtend;
...
const tzLocal = {
    ...
    lumi_trv: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            switch (key) {
                case 'system_mode':
                    await entity.write('manuSpecificLumi', { 0x0271: { value: utils.getFromLookup(value, { 'off': 0, 'heat': 1 }), type: 0x20 } }, { manufacturerCode: manufacturerCode });
                    break;
                case 'preset':
                    await entity.write('manuSpecificLumi', { 0x0272: { value: utils.getFromLookup(value, { 'manual': 0, 'auto': 1, 'away': 2 }), type: 0x20 } }, { manufacturerCode: manufacturerCode });
                    break;
    ...
    lumi_presence_region_upsert: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            const sortedZonesWithSets = command.zones
    ...
    CTPR01_operation_mode: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            const callback = async () => {
                await entity.write('manuSpecificLumi', { 0x0148: { value: utils.getFromLookup(value, lookup), type: 0x20 } }, { manufacturerCode: manufacturerCode, disableDefaultResponse: true });
...
const definitions = [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.lumi_contact, fromZigbee_1.default.ias_contact_alarm_1, lumi.fromZigbee.lumi_specific],
    ...
    },
    {
        ...
        fromZigbee: extend_1.default.light_onoff_brightness_colortemp_color().fromZigbee.concat([
            fromZigbee_1.default.lumi_power, lumi.fromZigbee.lumi_specific
        ]),
        toZigbee: extend_1.default.light_onoff_brightness_colortemp_color().toZigbee.concat([
            toZigbee_1.default.lumi_dimmer_mode, toZigbee_1.default.lumi_switch_power_outage_memory
        ]),
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [lumi.fromZigbee.lumi_basic, fromZigbee_1.default.lumi_WXKG01LM_action, legacy.fz.WXKG01LM_click],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.lumi_multistate_action, fromZigbee_1.default.lumi_WXKG11LM_action, lumi.fromZigbee.lumi_basic,
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_basic, fromZigbee_1.default.lumi_multistate_action, legacy.fz.WXKG12LM_action_click_multistate],
        toZigbee: [],
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.lumi_on_off_action, lumi.fromZigbee.lumi_basic, legacy.fz.WXKG03LM_click],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.lumi_on_off_action, fromZigbee_1.default.lumi_multistate_action, lumi.fromZigbee.lumi_basic,
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_basic, fromZigbee_1.default.lumi_on_off_action, fromZigbee_1.default.lumi_multistate_action],
        toZigbee: [],
        exposes: [e.battery(),
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.lumi_on_off_action, lumi.fromZigbee.lumi_basic, legacy.fz.WXKG02LM_click],
        toZigbee: [],
        onEvent: preventReset,
    },
    {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_multistate_action, lumi.fromZigbee.lumi_specific],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_switch_operation_mode_opple,
            toZigbee_1.default.lumi_flip_indicator_light, toZigbee_1.default.lumi_switch_mode_switch, toZigbee_1.default.lumi_switch_power_outage_memory],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_multistate_action, lumi.fromZigbee.lumi_specific],
        toZigbee: [
            toZigbee_1.default.on_off, toZigbee_1.default.lumi_switch_operation_mode_opple, toZigbee_1.default.lumi_flip_indicator_light,
            toZigbee_1.default.lumi_switch_power_outage_memory, toZigbee_1.default.lumi_switch_mode_switch
        ],
        exposes: [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_power, fromZigbee_1.default.lumi_multistate_action, lumi.fromZigbee.lumi_specific],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_power, toZigbee_1.default.lumi_switch_operation_mode_opple, toZigbee_1.default.lumi_switch_power_outage_memory,
            toZigbee_1.default.lumi_flip_indicator_light],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_power, fromZigbee_1.default.lumi_multistate_action, lumi.fromZigbee.lumi_specific],
        toZigbee: [
            toZigbee_1.default.on_off, toZigbee_1.default.lumi_power, toZigbee_1.default.lumi_switch_operation_mode_opple, toZigbee_1.default.lumi_switch_power_outage_memory,
            toZigbee_1.default.lumi_flip_indicator_light
        ],
        exposes: [
            e.switch().withEndpoint('top'),
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_multistate_action, lumi.fromZigbee.lumi_specific],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_switch_operation_mode_opple, toZigbee_1.default.lumi_switch_power_outage_memory,
            toZigbee_1.default.lumi_flip_indicator_light, toZigbee_1.default.lumi_led_disabled_night],
        meta: { multiEndpoint: true },
        endpoint: (device) => {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_power, lumi.fromZigbee.lumi_specific, fromZigbee_1.default.lumi_multistate_action],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_switch_operation_mode_opple, toZigbee_1.default.lumi_switch_power_outage_memory,
            toZigbee_1.default.lumi_led_disabled_night, toZigbee_1.default.lumi_flip_indicator_light],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_multistate_action, lumi.fromZigbee.lumi_specific],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_switch_operation_mode_opple, toZigbee_1.default.lumi_switch_power_outage_memory,
            toZigbee_1.default.lumi_flip_indicator_light, toZigbee_1.default.lumi_led_disabled_night, toZigbee_1.default.lumi_switch_mode_switch],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.lumi_on_off_ignore_endpoint_4_5_6, fromZigbee_1.default.lumi_on_off_action, legacy.fz.QBKG04LM_QBKG11LM_click,
            fromZigbee_1.default.lumi_operation_mode_basic],
        exposes: [
            e.switch(), e.action(['release', 'hold', 'double', 'single', 'hold_release']),
            e.enum('operation_mode', ea.STATE_SET, ['control_relay', 'decoupled'])
                .withDescription('Decoupled mode'),
        ],
        toZigbee: [toZigbee_1.default.on_off, { ...toZigbee_1.default.lumi_switch_operation_mode_basic, convertGet: null }],
        endpoint: (device) => {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.lumi_on_off_action, fromZigbee_1.default.lumi_multistate_action, fromZigbee_1.default.lumi_on_off_ignore_endpoint_4_5_6,
            legacy.fz.QBKG04LM_QBKG11LM_click, lumi.fromZigbee.lumi_basic, fromZigbee_1.default.lumi_operation_mode_basic,
            legacy.fz.QBKG11LM_click, fromZigbee_1.default.ignore_multistate_report, fromZigbee_1.default.lumi_power],
        exposes: [
        ...
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_switch_operation_mode_basic, toZigbee_1.default.lumi_power],
        endpoint: (device) => {
            return { 'system': 1 };
        },
        onEvent: preventReset,
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.lumi_on_off_action, fromZigbee_1.default.lumi_on_off_ignore_endpoint_4_5_6, legacy.fz.QBKG03LM_QBKG12LM_click,
            legacy.fz.QBKG03LM_buttons, fromZigbee_1.default.lumi_operation_mode_basic, lumi.fromZigbee.lumi_basic],
        exposes: [
        ...
        toZigbee: [toZigbee_1.default.on_off, { ...toZigbee_1.default.lumi_switch_operation_mode_basic, convertGet: null }, toZigbee_1.default.lumi_power],
        meta: { multiEndpoint: true },
        endpoint: (device) => {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.lumi_on_off_action, fromZigbee_1.default.lumi_multistate_action, fromZigbee_1.default.lumi_on_off_ignore_endpoint_4_5_6,
            legacy.fz.QBKG03LM_QBKG12LM_click, lumi.fromZigbee.lumi_basic, fromZigbee_1.default.lumi_operation_mode_basic, legacy.fz.QBKG12LM_click,
            fromZigbee_1.default.lumi_power],
        exposes: [
            e.switch().withEndpoint('left'),
            e.switch().withEndpoint('right'),
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_switch_operation_mode_basic],
        endpoint: (device) => {
            return { 'system': 1, 'default': 2 };
        },
        onEvent: preventReset,
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.lumi_on_off_ignore_endpoint_4_5_6, fromZigbee_1.default.lumi_on_off_action, legacy.fz.QBKG03LM_QBKG12LM_click,
            legacy.fz.QBKG03LM_buttons, fromZigbee_1.default.lumi_operation_mode_basic],
        exposes: [
            e.switch().withEndpoint('left'),
            e.switch().withEndpoint('right'),
            e.action(['release_left', 'release_right', 'release_both', 'double_left', 'double_right',
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_multistate_action, lumi.fromZigbee.lumi_specific],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_switch_operation_mode_opple, toZigbee_1.default.lumi_switch_power_outage_memory, toZigbee_1.default.lumi_led_disabled_night,
            toZigbee_1.default.lumi_switch_mode_switch, toZigbee_1.default.lumi_flip_indicator_light],
        meta: { multiEndpoint: true },
        endpoint: (device) => {
            return { 'left': 1, 'center': 2, 'right': 3 };
        },
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_power, lumi.fromZigbee.lumi_basic, fromZigbee_1.default.lumi_multistate_action],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_power, toZigbee_1.default.lumi_switch_operation_mode_basic],
        endpoint: (device) => {
            return { 'system': 1 };
        },
        onEvent: preventReset,
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_power, fromZigbee_1.default.lumi_multistate_action, fromZigbee_1.default.lumi_operation_mode_basic],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_power, toZigbee_1.default.lumi_switch_operation_mode_basic],
        meta: { multiEndpoint: true },
        endpoint: (device) => {
            return { 'left': 1, 'right': 2, 'system': 1 };
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_switch_operation_mode_opple, toZigbee_1.default.lumi_switch_power_outage_memory,
            toZigbee_1.default.lumi_led_disabled_night, toZigbee_1.default.lumi_flip_indicator_light],
        meta: { multiEndpoint: true },
        extend: [(0, modernExtend_1.forceDeviceType)({ type: 'Router' }), (0, modernExtend_1.forcePowerSource)({ powerSource: 'Mains (single phase)' }), lumiZigbeeOTA()],
        endpoint: (device) => {
            return { 'left': 1, 'right': 2 };
        },
        exposes: [
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [lumi.fromZigbee.lumi_basic, fromZigbee_1.default.lumi_temperature, fromZigbee_1.default.humidity],
        toZigbee: [],
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [lumi.fromZigbee.lumi_basic, fromZigbee_1.default.lumi_temperature, fromZigbee_1.default.humidity, fromZigbee_1.default.pressure],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_specific, fromZigbee_1.default.temperature, fromZigbee_1.default.humidity, fromZigbee_1.default.pressure, fromZigbee_1.default.battery],
        toZigbee: [],
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [lumi.fromZigbee.lumi_basic, fromZigbee_1.default.occupancy_with_timeout, fromZigbee_1.default.RTCGQ11LM_illuminance],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.lumi_occupancy_illuminance, lumi.fromZigbee.lumi_specific, fromZigbee_1.default.battery],
        toZigbee: [toZigbee_1.default.lumi_detection_interval],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.RTCGQ13LM_occupancy, lumi.fromZigbee.lumi_specific, fromZigbee_1.default.battery],
        toZigbee: [toZigbee_1.default.lumi_detection_interval, toZigbee_1.default.lumi_motion_sensitivity],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.lumi_occupancy_illuminance, lumi.fromZigbee.lumi_specific, fromZigbee_1.default.battery],
        toZigbee: [toZigbee_1.default.lumi_detection_interval, toZigbee_1.default.lumi_motion_sensitivity, toZigbee_1.default.RTCGQ14LM_trigger_indicator],
        exposes: [e.occupancy(), e.illuminance_lux().withProperty('illuminance'),
            e.illuminance().withUnit('lx').withDescription('Measured illuminance in lux'),
    ...
    },
    {
        ...
        toZigbee: [
            toZigbee_1.default.lumi_presence, toZigbee_1.default.lumi_monitoring_mode, toZigbee_1.default.lumi_approach_distance, toZigbee_1.default.lumi_motion_sensitivity,
            toZigbee_1.default.lumi_reset_nopresence_status, tzLocal.lumi_presence_region_upsert, tzLocal.lumi_presence_region_delete,
        ],
        exposes: [
            ...
            e.composite('region_upsert', 'region_upsert', ea.SET)
                ...
                .withValueMax(presence.constants.region_config_zoneY_max))).withDescription('list of dictionaries in the format {"x": 1, "y": 1}, {"x": 2, "y": 1}')),
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [lumi.fromZigbee.lumi_basic, fromZigbee_1.default.lumi_contact],
        toZigbee: [],
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [lumi.fromZigbee.lumi_basic, fromZigbee_1.default.MFKZQ01LM_action_multistate, fromZigbee_1.default.MFKZQ01LM_action_analog],
    ...
    },
    {
        ...
        vendor: 'Xiaomi',
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_power, lumi.fromZigbee.lumi_basic, fromZigbee_1.default.ignore_occupancy_report, fromZigbee_1.default.ignore_illuminance_report],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_switch_power_outage_memory, toZigbee_1.default.lumi_power],
    ...
    },
    {
        ...
        vendor: 'Xiaomi',
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_power, lumi.fromZigbee.lumi_basic, fromZigbee_1.default.ignore_occupancy_report, fromZigbee_1.default.ignore_illuminance_report],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_power],
    ...
    },
    {
        ...
        vendor: 'Xiaomi',
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_power, lumi.fromZigbee.lumi_specific, fromZigbee_1.default.ignore_occupancy_report, fromZigbee_1.default.ignore_illuminance_report,
            fromZigbee_1.default.ignore_time_read],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_power, toZigbee_1.default.lumi_switch_power_outage_memory, toZigbee_1.default.lumi_auto_off, toZigbee_1.default.lumi_led_disabled_night,
            toZigbee_1.default.lumi_overload_protection],
        exposes: [
    ...
    },
    {
        ...
        vendor: 'Aqara',
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_power, lumi.fromZigbee.lumi_specific, lumi.fromZigbee.lumi_basic,
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, lumi.fromZigbee.lumi_basic, fromZigbee_1.default.electrical_measurement, fromZigbee_1.default.metering,
            lumi.fromZigbee.lumi_specific, fromZigbee_1.default.lumi_power, fromZigbee_1.default.device_temperature],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_switch_power_outage_memory, toZigbee_1.default.lumi_led_disabled_night,
            toZigbee_1.default.lumi_overload_protection, toZigbee_1.default.lumi_auto_off, toZigbee_1.default.lumi_socket_button_lock],
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_power, fromZigbee_1.default.ignore_occupancy_report, lumi.fromZigbee.lumi_basic],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_power, toZigbee_1.default.lumi_led_disabled_night,
            toZigbee_1.default.lumi_switch_power_outage_memory, toZigbee_1.default.lumi_auto_off],
    ...
    },
    {
        ...
        vendor: 'Aqara',
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_power, lumi.fromZigbee.lumi_basic],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_switch_power_outage_memory, toZigbee_1.default.lumi_power],
        exposes: [e.switch(), e.power().withAccess(ea.STATE_GET), e.energy(), e.device_temperature().withAccess(ea.STATE),
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [lumi.fromZigbee.lumi_basic, fromZigbee_1.default.JTYJGD01LMBW_smoke],
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.lumi_alarm, toZigbee_1.default.lumi_density, toZigbee_1.default.JTBZ01AQA_gas_sensitivity, toZigbee_1.default.lumi_selftest, toZigbee_1.default.lumi_buzzer,
            toZigbee_1.default.lumi_buzzer_manual, toZigbee_1.default.lumi_linkage_alarm, toZigbee_1.default.JTBZ01AQA_state, toZigbee_1.default.lumi_power_outage_count],
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.lumi_alarm, toZigbee_1.default.lumi_density, toZigbee_1.default.lumi_selftest, toZigbee_1.default.lumi_buzzer, toZigbee_1.default.lumi_buzzer_manual,
            toZigbee_1.default.JYGZ01AQ_heartbeat_indicator, toZigbee_1.default.lumi_linkage_alarm],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.lumi_lock_report],
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [lumi.fromZigbee.lumi_basic, fromZigbee_1.default.DJT11LM_vibration],
    ...
    },
    {
        ...
        vendor: 'Aqara',
        fromZigbee: [lumi.fromZigbee.lumi_basic, fromZigbee_1.default.lumi_curtain_position, fromZigbee_1.default.lumi_curtain_position_tilt],
        toZigbee: [toZigbee_1.default.lumi_curtain_position_state, toZigbee_1.default.lumi_curtain_options],
        onEvent: async (type, data, device) => {
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_basic, fromZigbee_1.default.lumi_curtain_position, fromZigbee_1.default.lumi_curtain_position_tilt, fromZigbee_1.default.lumi_curtain_hagl04_status],
        toZigbee: [toZigbee_1.default.lumi_curtain_position_state, toZigbee_1.default.lumi_curtain_options],
        onEvent: async (type, data, device) => {
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_basic, fromZigbee_1.default.lumi_curtain_position, fromZigbee_1.default.lumi_curtain_position_tilt, fromZigbee_1.default.lumi_curtain_hagl07_status],
        toZigbee: [toZigbee_1.default.lumi_curtain_position_state, toZigbee_1.default.lumi_curtain_options],
        onEvent: async (type, data, device) => {
            // The position (genAnalogOutput.presentValue) reported via an attribute contains an invalid value
            // however when reading it will provide the correct value.
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.lumi_curtain_position, fromZigbee_1.default.lumi_curtain_acn002_status, fromZigbee_1.default.ignore_basic_report, lumi.fromZigbee.lumi_specific],
        toZigbee: [toZigbee_1.default.lumi_curtain_position_state, toZigbee_1.default.lumi_curtain_acn002_battery, toZigbee_1.default.lumi_curtain_acn002_charging_status],
        onEvent: async (type, data, device) => {
    ...
    },
    {
        ...
        fromZigbee: [
            ...
            fromZigbee_1.default.lumi_curtain_position_tilt,
            lumi.fromZigbee.lumi_specific,
            fromZigbee_1.default.power_source,
        ],
        toZigbee: [
            toZigbee_1.default.lumi_curtain_position_state,
            toZigbee_1.default.lumi_curtain_battery_voltage,
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_basic, fromZigbee_1.default.lumi_power, fromZigbee_1.default.ignore_multistate_report, fromZigbee_1.default.on_off, lumi.fromZigbee.lumi_basic_raw],
        meta: { multiEndpoint: true },
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.LLKZMK11LM_interlock, toZigbee_1.default.lumi_power, toZigbee_1.default.lumi_switch_power_outage_memory],
        endpoint: (device) => {
            return { 'l1': 1, 'l2': 2 };
        },
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, lumi.fromZigbee.lumi_specific, fromZigbee_1.default.lumi_power],
    ...
    },
    {
        ...
        vendor: 'Aqara',
        fromZigbee: [lumi.fromZigbee.lumi_basic, fromZigbee_1.default.ZNMS12LM_ZNMS13LM_closuresDoorLock_report, fromZigbee_1.default.ZNMS12LM_low_battery],
        toZigbee: [],
        exposes: [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.aqara_opple_on, fromZigbee_1.default.aqara_opple_off, fromZigbee_1.default.battery, fromZigbee_1.default.aqara_opple_multistate, lumi.fromZigbee.lumi_specific],
        exposes: [e.battery(), e.battery_voltage(), e.action([
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.aqara_opple_on, fromZigbee_1.default.aqara_opple_off, fromZigbee_1.default.aqara_opple_step, fromZigbee_1.default.aqara_opple_step_color_temp, fromZigbee_1.default.battery,
            fromZigbee_1.default.aqara_opple_multistate, lumi.fromZigbee.lumi_specific],
        exposes: [e.battery(), e.battery_voltage(), e.action([
                'button_1_hold', 'button_1_release', 'button_1_single', 'button_1_double', 'button_1_triple',
                'button_2_hold', 'button_2_release', 'button_2_single', 'button_2_double', 'button_2_triple',
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.aqara_opple_on, fromZigbee_1.default.aqara_opple_off, fromZigbee_1.default.aqara_opple_step, fromZigbee_1.default.aqara_opple_move, fromZigbee_1.default.aqara_opple_stop,
            fromZigbee_1.default.aqara_opple_step_color_temp, fromZigbee_1.default.aqara_opple_move_color_temp, fromZigbee_1.default.battery, fromZigbee_1.default.aqara_opple_multistate, lumi.fromZigbee.lumi_specific],
        exposes: [e.battery(), e.battery_voltage(), e.action([
                'button_1_hold', 'button_1_release', 'button_1_single', 'button_1_double', 'button_1_triple',
                'button_2_hold', 'button_2_release', 'button_2_single', 'button_2_double', 'button_2_triple',
                'button_3_hold', 'button_3_release', 'button_3_single', 'button_3_double', 'button_3_triple',
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.light)({ colorTemp: { range: undefined }, color: true }), lumiZigbeeOTA()],
    },
    {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.device_temperature, lumi.fromZigbee.lumi_specific, fromZigbee_1.default.ignore_metering, fromZigbee_1.default.ignore_electrical_measurement,
            fromZigbee_1.default.lumi_power],
        ...
        toZigbee: [toZigbee_1.default.lumi_switch_type, toZigbee_1.default.on_off, toZigbee_1.default.lumi_switch_power_outage_memory, toZigbee_1.default.lumi_led_disabled_night],
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_power, lumi.fromZigbee.lumi_specific],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_power, toZigbee_1.default.lumi_switch_type, toZigbee_1.default.lumi_switch_power_outage_memory, toZigbee_1.default.lumi_led_disabled_night],
        exposes: [e.switch(), e.power().withAccess(ea.STATE_GET), e.energy(), e.device_temperature().withAccess(ea.STATE),
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.lumi_switch_type, toZigbee_1.default.on_off, toZigbee_1.default.lumi_switch_power_outage_memory],
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
            await reporting.bind(endpoint, coordinatorEndpoint, ['genOnOff']);
            await reporting.onOff(endpoint);
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [fromZigbee_1.default.lumi_on_off_action, fromZigbee_1.default.lumi_multistate_action, fromZigbee_1.default.battery, lumi.fromZigbee.lumi_specific],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.lumi_multistate_action, lumi.fromZigbee.lumi_specific, fromZigbee_1.default.command_toggle],
        toZigbee: [toZigbee_1.default.lumi_switch_click_mode, toZigbee_1.default.aqara_opple_operation_mode],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_power, lumi.fromZigbee.lumi_specific],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_switch_power_outage_memory, toZigbee_1.default.lumi_led_disabled_night,
            toZigbee_1.default.lumi_overload_protection, toZigbee_1.default.lumi_socket_button_lock],
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.aqara_opple_multistate, lumi.fromZigbee.lumi_specific],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_power, lumi.fromZigbee.lumi_specific],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_switch_power_outage_memory, toZigbee_1.default.lumi_led_disabled_night,
            toZigbee_1.default.lumi_button_switch_mode, toZigbee_1.default.lumi_overload_protection, toZigbee_1.default.lumi_socket_button_lock],
        meta: { multiEndpoint: true },
        endpoint: () => {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.lumi_contact, lumi.fromZigbee.lumi_specific, fromZigbee_1.default.ias_contact_alarm_1],
        toZigbee: [],
        exposes: [e.contact(), e.battery(), e.battery_voltage()],
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        extend: [lumiZigbeeOTA()],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.lumi_on_off_action, fromZigbee_1.default.lumi_multistate_action, lumi.fromZigbee.lumi_basic,
            lumi.fromZigbee.lumi_specific, fromZigbee_1.default.lumi_knob_rotation],
        toZigbee: [toZigbee_1.default.aqara_opple_operation_mode],
        onEvent: preventReset,
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint1 = device.getEndpoint(1);
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [fromZigbee_1.default.lumi_multistate_action, lumi.fromZigbee.lumi_specific],
        toZigbee: [toZigbee_1.default.lumi_switch_click_mode],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.lumi_multistate_action, lumi.fromZigbee.lumi_specific, fromZigbee_1.default.command_toggle],
        toZigbee: [toZigbee_1.default.lumi_switch_click_mode, toZigbee_1.default.aqara_opple_operation_mode],
    ...
    },
    {
        ...
        fromZigbee: [fzLocal.lumi_trv, fromZigbee_1.default.thermostat, fromZigbee_1.default.battery],
        toZigbee: [tzLocal.lumi_trv, toZigbee_1.default.thermostat_occupied_heating_setpoint],
        exposes: [
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [lumi.fromZigbee.lumi_basic, fromZigbee_1.default.aqara_opple_multistate, lumi.fromZigbee.lumi_specific],
        toZigbee: [],
        endpoint: (device) => {
            return { left: 1, right: 2, both: 3 };
        },
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_multistate_action, lumi.fromZigbee.lumi_specific, fromZigbee_1.default.lumi_power],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_switch_operation_mode_opple, toZigbee_1.default.lumi_switch_power_outage_memory,
            toZigbee_1.default.lumi_led_disabled_night, toZigbee_1.default.lumi_switch_lock_relay_opple],
        meta: { multiEndpoint: true },
        endpoint: (device) => {
            return { 'button': 1 };
        },
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_multistate_action, lumi.fromZigbee.lumi_specific, fromZigbee_1.default.lumi_power],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_switch_operation_mode_opple, toZigbee_1.default.lumi_switch_power_outage_memory,
            toZigbee_1.default.lumi_led_disabled_night, toZigbee_1.default.lumi_switch_lock_relay_opple, toZigbee_1.default.lumi_switch_click_mode],
        meta: { multiEndpoint: true },
        endpoint: (device) => {
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        extend: [lumiZigbeeOTA()],
        fromZigbee: [lumi.fromZigbee.lumi_specific, fzLocal.CTPR01_action_multistate, fzLocal.CTPR01_action_analog, fromZigbee_1.default.ignore_onoff_report],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_multistate_action, lumi.fromZigbee.lumi_specific],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.lumi_switch_operation_mode_opple, toZigbee_1.default.lumi_switch_power_outage_memory, toZigbee_1.default.lumi_switch_mode_switch,
            toZigbee_1.default.lumi_flip_indicator_light],
        endpoint: (device) => {
            return { 'left': 1, 'center': 2, 'right': 3 };
        },
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.lumi_power, fromZigbee_1.default.lumi_multistate_action, lumi.fromZigbee.lumi_specific],
        toZigbee: [
            toZigbee_1.default.on_off, toZigbee_1.default.lumi_switch_operation_mode_opple, toZigbee_1.default.lumi_switch_power_outage_memory,
            toZigbee_1.default.lumi_led_disabled_night, toZigbee_1.default.lumi_flip_indicator_light,
        ],
        exposes: [
