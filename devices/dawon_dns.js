...
const definitions = [
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.onOff)({ endpoints: { top: 1, bottom: 2 }, powerOnBehavior: false })],
    },
    {
        ...
        extend: [(0, modernExtend_1.onOff)({ endpoints: { top: 1, center: 2, bottom: 3 }, powerOnBehavior: false })],
    },
    {
    ...
    },
    {
        ...
        vendor: 'Dawon DNS',
        description: 'IOT smart switch 2 gang without neutral wire',
        extend: [(0, modernExtend_1.onOff)({ endpoints: { top: 1, bottom: 2 }, powerOnBehavior: false }), (0, modernExtend_1.forcePowerSource)({ powerSource: 'Mains (single phase)' })],
    },
    {
        ...
        vendor: 'Dawon DNS',
        description: 'IOT smart switch 3 gang without neutral wire',
        extend: [(0, modernExtend_1.onOff)({ endpoints: { top: 1, center: 2, bottom: 3 }, powerOnBehavior: false }), (0, modernExtend_1.forcePowerSource)({ powerSource: 'Mains (single phase)' })],
    },
    {
