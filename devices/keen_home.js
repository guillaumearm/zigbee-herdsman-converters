...
const definitions = [
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.lumi_temperature, fromZigbee_1.default.humidity, fromZigbee_1.default.keen_home_smart_vent_pressure],
        toZigbee: [],
