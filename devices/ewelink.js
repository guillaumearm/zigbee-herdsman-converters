...
const definitions = [
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.onOff)({ endpoints: { left: 1, right: 2 }, configureReporting: false })],
        onEvent: async (type, data, device) => {
            device.skipDefaultResponse = true;
        },
    },
    {
        ...
        extend: [(0, modernExtend_1.onOff)({ endpoints: { left: 1, center: 2, right: 3 }, configureReporting: false })],
        onEvent: async (type, data, device) => {
            device.skipDefaultResponse = true;
        },
    },
    {
        ...
        extend: [(0, modernExtend_1.onOff)({ endpoints: { l1: 1, l2: 2, l3: 3, l4: 4 }, configureReporting: false })],
        onEvent: async (type, data, device) => {
            device.skipDefaultResponse = true;
        },
    },
    {
        ...
        extend: [(0, modernExtend_1.onOff)({ endpoints: { l1: 1, l2: 2, l3: 3, l4: 4, l5: 5 }, configureReporting: false })],
        onEvent: async (type, data, device) => {
            device.skipDefaultResponse = true;
        },
    },
