...
const definitions = [
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.onOff)({ endpoints: { left: 1, right: 2 } })],
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.onOff)({ endpoints: { l1: 1, l2: 2, l3: 3, l4: 4 } })],
    },
    {
        ...
        extend: [(0, modernExtend_1.onOff)({ endpoints: { top: 16, center: 17, bottom: 18 } })],
    },
    {
        ...
        vendor: 'Nue / 3A',
        description: 'Smart light switch - 4 gang v2.0',
        extend: [(0, modernExtend_1.onOff)({ endpoints: { top_left: 16, top_right: 17, bottom_right: 18, bottom_left: 19 } })],
    },
    {
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.onOff)({ endpoints: { top: 16, bottom: 17 } })],
    },
    {
        fingerprint: [
        ...
        extend: [(0, modernExtend_1.onOff)({ endpoints: { top: 11, bottom: 12 }, configureReporting: false })],
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.onOff)({ endpoints: { left: 11, right: 12 } })],
    },
    {
    ...
    },
    {
        ...
        extend: [
            (0, modernExtend_1.onOff)({ endpoints: { button_light: 1, button_fan_high: 2, button_fan_med: 3, button_fan_low: 4 } }),
